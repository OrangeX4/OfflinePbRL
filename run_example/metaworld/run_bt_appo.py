...
def get_args():
    ...
    parser.add_argument("--rm_stop_epoch", type=int, default=50)
    parser.add_argument("--policy_start_epoch", type=int, default=50)
...
def train(args=get_args()):
    ...
    # log
    log_dirs = make_log_dirs(args.domain, args.algo_name, args.task, args.seed, vars(args), record_params=['feedback_num'])
