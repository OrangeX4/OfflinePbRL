...
def get_args():
    ...
    parser.add_argument("--pref_batch_size", type=int, default=32)
...
def train(args=get_args()):
    ...
    # log
    log_dirs = make_log_dirs(args.domain, args.algo_name, args.task, args.seed, vars(args), record_params=["adversarial_weight", "feedback_num"])
