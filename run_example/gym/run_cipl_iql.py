...
from offlinepbrl.policy import CIPLIQLPolicy

"""
suggested hypers
expectile=0.7, temperature=0.3 for all D4RL-Gym tasks
CIPL specific: reward_reg=0.5, cql_weight=1.0, use_logsumexp=True
"""
...
def get_args():
    ...
    parser.add_argument("--algo_name", type=str, default="cipl_iql")
...
def train(args=get_args()):
    ...
    # create CIPL-IQL policy
    policy = CIPLIQLPolicy(
        actor,
        critic_q1,
        critic_q2,
        critic_v,
