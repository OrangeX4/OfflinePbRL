...
from offlinepbrl.policy import MOPOPolicy
...
hopper-medium-v2: rollout_length=5, penalty_coef=5.0
walker2d-medium-v2: rollout_length=5, penalty_coef=0.5
halfcheetah-medium-replay-v2: rollout_length=5, penalty_coef=0.5
hopper-medium-replay-v2: rollout_length=5, penalty_coef=2.5
walker2d-medium-replay-v2: rollout_length=1, penalty_coef=2.5
halfcheetah-medium-expert-v2: rollout_length=5, penalty_coef=2.5
hopper-medium-expert-v2: rollout_length=5, penalty_coef=5.0
walker2d-medium-expert-v2: rollout_length=1, penalty_coef=2.5
"""
...
def get_args():
    ...
    parser.add_argument("--algo_name", type=str, default="mopo_p")
...
def train(args=get_args()):
    ...
    # log
    log_dirs = make_log_dirs(args.domain, args.algo_name, args.task, args.seed, vars(args), record_params=["uncertainty_mode", "reward_uncertainty_mode", "penalty_coef", "rollout_length"])
