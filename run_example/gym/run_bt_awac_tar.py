...
from offlinepbrl.policy import BTAWACTARPolicy
...
def get_args():
    ...
    parser.add_argument("--algo_name", type=str, default="bt_awac_tar")
...
def train(args=get_args()):
    ...
    # create BT-AWAC-TAR policy
    policy = BTAWACTARPolicy(
        actor,
        critic_q1,
        critic_q2,
        actor_optim,
