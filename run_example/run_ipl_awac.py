...
from offlinepbrl.policy import IPLAWACPolicy

"""
suggested hypers
temperature=0.3 for all D4RL-Gym tasks
...
def get_args():
    ...
    parser.add_argument("--algo-name", type=str, default="ipl_awac")
...
def train(args=get_args()):
    ...
    # create IPL-AWAC policy
    policy = IPLAWACPolicy(
        actor,
        critic_q1,
        critic_q2,
        actor_optim,
