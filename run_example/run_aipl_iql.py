...
def get_args():
    ...
    parser.add_argument("--algo-name", type=str, default="aipl_iql")
    ...
    parser.add_argument("--reward-reg", type=float, default=0.5)
    parser.add_argument("--adversarial-weight", type=float, default=0.1)
    parser.add_argument("--reg-replay-weight", type=float, default=0.5)
    parser.add_argument("--actor-replay-weight", type=float, default=0.5)
    parser.add_argument("--value-replay-weight", type=float, default=0.5)
